...
PANEL_ATTACHMENT_PROFILES: dict[str, dict[str, Any]] = {
    "p02": {
        ...
        "tail_policy": {
            "mode": "edge_select",
            "anchor_preference": "speaker_facing_edge",
            "min_clearance_from_forbidden": 0.03,
            "max_cross_ratio": 0.02,
        },
        "tail_overrides": {},
    },
    "p06": {
        ...
        "speaker_local_zones": [
            ...
            },
            {
                ...
                "priority": 80,
                "confidence": 0.79,
                "rationale": "secondary shelf that keeps the tail out of the laptop glow",
                "source": "panel_override",
            },
        ],
        "panel_overrides": {
        ...
        "tail_policy": {
            ...
            "anchor_preference": "speaker_facing_edge",
            "min_clearance_from_forbidden": 0.03,
            "max_cross_ratio": 0.015,
        },
        "tail_overrides": {
            "l03": {
                "speaker_anchor_id": "mother_mouth_primary",
                "bend_point": None,
            }
        },
    },
...
def build_attachment_contract(panel_id: str, items: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    tail_overrides = {item_id: dict(value) for item_id, value in profile.get("tail_overrides", {}).items() if item_id in item_ids}
    return {
        ...
        "tail_policy": dict(profile.get("tail_policy", {})),
        "tail_overrides": tail_overrides,
    }
...
def build_render_hints(
    ...
    allow_tail = any(template == "speech" for template in item_templates.values())
    ...
    return {
        ...
        "tail_policy": attachment_contract["tail_policy"],
        "tail_overrides": attachment_contract["tail_overrides"],
    }
